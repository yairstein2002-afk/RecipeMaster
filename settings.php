...
session_start();
//היא מוודא שרק מי שהתחבר בהצלחה יוכל לראות את התוכן, וכל השאר ייזרקו החוצה.
if (!isset($_SESSION['user_id'])) { 
    header("Location: login.php"); 
    exit; 
}
//זו הדרך המקצועית והבטוחה ביותר לוודא שכל דף באתר שלך יודע איך לדבר עם מסד הנתונים שלך בלי לשכפל קוד.
require_once 'db.php';
//זו השורה שהופכת את האתר מ"לוח מודעות כללי" לאתר אישי שמותאם בדיוק למשתמש שנמצא מול המסך.
