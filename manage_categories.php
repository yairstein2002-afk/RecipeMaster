...
//איפוס" או הכנה של משתנה. היא אומרת למחשב: "כרגע, אין שום קטגוריה שנמצאת במצב עריכה"
$edit_cat = null;

//זהו מנגנון חכם שמאפשר להשתמש באותו טופס גם להוספה וגם לעריכה, לפי קיום או אי-קיום של תעודת הזהות (ID) של הקטגוריה.
if (isset($_POST['save_category'])) {
    ...
    if (!empty($name) && !empty($icon)) {
        ...
        //זו פקודת ריענון והפניה. היא אומרת לדפדפן: "סייימתי לעבוד, עכשיו תטען מחדש את הדף
...
//השורה הזו היא הדרך של האתר "להביא את כל המגירות" (הקטגוריות) מהמחסן (מסד הנתונים) כדי להציג אותן בדף.
