...
// לוגיקה: מנהל תמיד מאושר, משתמשים נשלפים מהסשן
...
<div class="header-container">
    ...
    <div class="admin-tools">
        ...
        <a href="admin_users.php" style="color: white; text-decoration: none;">ניהול משתמשים 👥</a>
    </div>
    <?php endif; ?>
</div>
...
function toggleSection(secId, btn) {
    ...
    items.forEach((item, index) => { if (index >= 4) item.style.display = isOpening ? "block" : "none"; });
