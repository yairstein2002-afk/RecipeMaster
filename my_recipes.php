...
function setStatusFilter(status, btn) {
    //הפונקציה "מכבה" את הצבע הפעיל מכל כפתורי הסינון האחרים ומדליקה אותו רק על הכפתור שעליו לחצת כרגע. זה נותן למשתמש חיווי ויזואלי ברור איפה הוא נמצא.
...
function applyFilters() {
    //הפונקציה לוקחת את מה שהמשתמש הקליד בשורת החיפוש והופכת אותו לאותיות קטנות (כדי שהחיפוש לא יהיה רגיש להבדלים בין אותיות גדולות לקטנות).
...
//רק אם המצרך עומד בכל התנאים (גם החיפוש וגם הסטטוס), הוא יוצג (flex). אחרת, הוא יוסתר (none).
