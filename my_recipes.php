...
<head>
    ...
    <style>
        ...
        /* תיקון סרגל קטגוריות - מיושר למרכז */
        .category-nav { 
            position: sticky; 
            top: 0; 
            z-index: 1000; 
...
<div class="header-section">
    <div class="welcome-card">
        ...
        <div>
            ...
            <p style="margin: 5px 0 0; color: var(--accent); font-size: 1.1rem;">ניהול כל המתכונים האישיים שלך.</p>
        </div>
    </div>
...
<div class="container">
    <?php if(empty($my_categories)): ?>
        <div style="text-align:center; padding:100px; opacity:0.5;">
            ...
            <a href="add_recipe.php" style="color:var(--accent);">לחץ כאן להוספת המתכון הראשון!</a>
        </div>
    <?php endif; ?>
